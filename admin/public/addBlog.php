...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['title_image']['name'])) {
        $title_image_directory = __DIR__ . "admin/uploads/photos/";
    ...
    if (!empty($_FILES['main_image']['name'])) {
        $main_image_directory = __DIR__ . "admin/uploads/photos/";
    ...
    if (!empty($_FILES['video']['name'])) {
        $video_directory = __DIR__ . "admin/uploads/videos/";  // Adjust the upload directory path for videos
