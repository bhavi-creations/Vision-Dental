            ...
            <div class="container">
                <div class="row servSect">
                    ...
                    <div class="col-md-6 dr_content_padding  order-1 order-md-1  ">
                        <h2 class="dr_welcome_text1 mt-4 mb-4">What is a Root Canal <br>
                            Treatment?
                        </h2>
                        <p class="poetsen_font1">
                        ...
                        <h2 class="dr_welcome_text11 mt-4 mb-4">Why Do You Need Root Canal Treatment in Guntur?
                        </h2><h2 class="dr_welcome_text11 mt-4 mb-4">Benefits of Root Canal Treatment in Guntur:
                        </h2>
