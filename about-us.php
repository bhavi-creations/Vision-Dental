      ...
      <div class="row servSect">
        ...
        <div class="col-md-6 dr_content_padding  order-1 order-md-1">
          ...
          <p class="poetsen_font1">
            ...
            Whether you need routine dental check-ups, cavity and  <a href="root-canal-treatments-in-guntur.php">root canal treatments</a> ,     <a href="dentalbraces-treatments-in-guntur.php">braces</a>    ,  <a href="dental-implants-treatments-in-guntur.php"> implants</a>    ,   or    <a href="smile-makeover-treatments-in-guntur.php"> smile makeovers</a>, our focus is on delivering safe, precise, and compassionate care for every patient.
        ...
        <div class="col-md-6 order-3  order-md-2 mt-5">
          <!-- <img src="assets/img/about/about_new.jpeg" class="img-fluid dr_img_padding abouter" alt="" style="border-radius: 4px;"> -->
          <img src="assets/img/about/a11.png" class="img-fluid dr_img_padding abouter" alt="dr.abhilash">
        </div>
