                        ...
                        <ul class="dropdown-menu services_drop_menu service_width  mt-3" aria-labelledby="servicesDropdown" style="width:550px;">
                            <div class="row  ">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <li><a class="dropdown-item services_drop active" href="lasion.php">Precancerous Lesion</a></li>
            ...
            <div class="container">
                <div class="row servSect">
                    ...
                    <div class="col-md-6 order-3  order-md-2 mt-5 text-center">
                        <img src="assets/img/about/Precancerous Lesion.webp" class="img-fluid dr_img_padding abouter1" alt="">
                    </div>
            ...
            <div class="container">
                <div class="row servSect">
                    ...
                    <div class="col-md-12 dr_content_padding  order-1 order-md-1  ">
                        <h2 class="dr_welcome_text1 mt-4 mb-4">What are Precancerous Lesion in Mouth Treatment?
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h2 class="dr_welcome_text11 mt-4 mb-4">Why You Need Precancerous Lesion in the Mouth Treatment?
                            ...
                            <div class="col-md-6">
                                <h2 class="dr_welcome_text11 mt-4 mb-4">Benefits of Precancerous Lesion in the Mouth Treatment:
