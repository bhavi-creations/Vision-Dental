      ...
      <div class="container">
        <div class="row servSect">
          ...
          <div class="col-md-12 dr_content_padding  order-1 order-md-1  ">
            ...
            <div class="row">
              <div class="col-md-6">
                <h2 class="dr_welcome_text11 mt-4 mb-4">Why Do You Need Dentures Treatment in Guntur?
                </h2>
              ...
              <div class="col-md-6">
                <h2 class="dr_welcome_text11 mt-4 mb-4">Benefits of Dentures Treatment in Guntur:
